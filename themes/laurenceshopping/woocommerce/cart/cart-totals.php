...
?>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

		<?php do_action( 'woocommerce_before_cart_totals' ); ?>

		<h4><?php _e( 'Cart Totals', 'woocommerce' ); ?></h4>
		<div class="cart-totals_wrap">
			<table cellspacing="0">
