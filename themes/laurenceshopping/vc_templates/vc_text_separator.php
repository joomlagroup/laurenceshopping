...
<?php if( $type == 'type_1' ){ ?>
	<div class="<?php echo esc_attr(trim($css_class)); ?>">
		<span class="vc_sep_holder vc_sep_holder_l"><span<?php echo balanceTags( $inline_css, true ); ?> class="vc_sep_line"></span></span>
		<?php if($title!=''): ?><h4><?php echo balanceTags( $title, true ); ?></h4><?php endif; ?>
		<span class="vc_sep_holder vc_sep_holder_r"><span<?php echo balanceTags( $inline_css, true ); ?> class="vc_sep_line"></span></span>
	</div>
